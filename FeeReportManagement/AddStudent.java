    ...
    public void actionPerformed(ActionEvent e)
    {
            ...
            if(e.getSource()==bt1 )
        {
            try
           {
               ...
               String q="insert into add_student(name,email,course,fee,paid,due,address,city,state,country,mobile)value('"+name+"','"+email+"','"+course+"','"+fee+"','"+paid+"','"+due+"','"+address+"','"+city+"','"+state+"','"+country+"','"+mobile+"')";
