    ...
    public void actionPerformed(ActionEvent e)
    {
             ...
             if(e.getSource()==bt1 )
        {
            try
           {
               ...
               String q="update  add_student set name='"+name+"',email='"+email+"',course='"+course+"',fee='"+fee+"',paid='"+paid+"',due='"+due+"',address='"+address+"',city='"+city+"',state='"+state+"',country='"+country+"',mobile='"+mobile+"' where rollno='"+roll+"'";
               int aa=obj2.stm.executeUpdate(q);
               if(aa==1)
               {
                JOptionPane.showMessageDialog(null,"Your Data is succussfully Updated");
                     this.setVisible(false);
               }
               
               else
               {
                  JOptionPane.showMessageDialog(null,"Please ! Fill Detailes with Carefully !");
